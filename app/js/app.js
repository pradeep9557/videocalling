...
function initializeClient() {
  ...
  $.getJSON('/matrixnad-sachin-agora-integration-d45bc6ca0157/app/app_id.php', function(json) {
    joinData = json;
...
function startRecording() {
  ...
  $.post("/matrixnad-sachin-agora-integration-d45bc6ca0157/app/start_recording.php", payload, function() {
